...
class App:
    ...
    def __init__(self, root):
        ...
        btn_pick_background = tk.Button(root)
        btn_pick_background["bg"] = "#efefef"
        ft = tkFont.Font(family='Courier', size=12)
        btn_pick_background["font"] = ft
        btn_pick_background["fg"] = "#000000"
        btn_pick_background["justify"] = "center"
        btn_pick_background["text"] = "Chọn ảnh nền"
        btn_pick_background.place(x=20, y=580, width=108, height=30)
        btn_pick_background["command"] = self.btn_pick_background_command

        btn_pick_main_image = tk.Button(root)
        btn_pick_main_image["bg"] = "#efefef"
        ft = tkFont.Font(family='Courier', size=12)
        btn_pick_main_image["font"] = ft
        btn_pick_main_image["fg"] = "#000000"
        btn_pick_main_image["justify"] = "center"
        btn_pick_main_image["text"] = "Chọn ảnh chính"
        btn_pick_main_image.place(x=140, y=580, width=111, height=30)
        btn_pick_main_image["command"] = self.btn_pick_main_image_command
...
# 3.
    ...
    def btn_process_contrast_command(self):
        self.img_contrast = self.filter_f1(self.img, alpha=0.9, a=100)
